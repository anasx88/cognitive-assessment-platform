...
const QUESTION_BANK = [
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أختار الأسرع عند ضغط الوقت.", score: 1 },
      { id: "B", text: "أدرس خيار الأثر الأعلى.", score: 2 },
      { id: "C", text: "أطلب رأيًا داعمًا للقرار.", score: 1 },
      { id: "D", text: "أقارن الأثر والوقت والمخاطر.", score: 3 }
    ]
  },
  {
    id: "TH-005",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "رأي مختصر مع توصية مبدئية.", score: 1 },
      { id: "B", text: "قائمة حلول مع مبررات أولية.", score: 2 },
      { id: "C", text: "وصف عام للوضع الحالي.", score: 1 },
      { id: "D", text: "تعريف المشكلة والسبب والأثر والتوصية.", score: 3 }
    ]
  },
  {
    id: "AN-006",
...

  {
    ...
    options: [
      { id: "A", text: "أستمر إذا ظهرت نتيجة بسرعة.", score: 1 },
      { id: "B", text: "أبحث عن مصدر أكثر تحفيزًا.", score: 1 },
      { id: "C", text: "أحتاج نظام متابعة واضح للاستمرار.", score: 3 },
      { id: "D", text: "أؤجل التطبيق حتى يتضح المسار.", score: 1 }
    ]
  },
  {
    id: "SD-002",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أدافع عن عملي إذا فهمت الملاحظة.", score: 1 },
      { id: "B", text: "أطلب مثالًا محددًا لموضع التحسين.", score: 3 },
      { id: "C", text: "أراجع النقد قبل الحكم عليه.", score: 2 },
      { id: "D", text: "أعيد الجزء المتأثر من العمل.", score: 1 }
    ]
  },
  {
    id: "SD-006",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Assessment-Report-Final", score: 1 },
      { id: "C", text: "Assessment-Report-New", score: 1 },
      { id: "D", text: "Assessment-Report-Draft", score: 2 }
    ]
  },
  {
    id: "DA-003",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Word لكتابة ملاحظات مختصرة.", score: 1 },
      { id: "B", text: "PowerPoint لعرض النتيجة.", score: 1 },
      { id: "C", text: "Excel للفرز والحساب والمقارنة.", score: 3 },
      { id: "D", text: "جدول مصور للمراجعة البصرية.", score: 1 }
    ]
  },
  {
    id: "DA-005",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "الطلب كان عامًا وغير محدد.", score: 2 },
      { id: "B", text: "الطلب ناقص السياق والهدف.", score: 3 },
      { id: "C", text: "الموضوع يحتاج تفصيلًا أكثر.", score: 1 },
      { id: "D", text: "الإجابة تحتاج قيودًا أو مثالًا.", score: 2 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أرسل التقرير مع توضيح الملاحظة.", score: 1 },
      { id: "B", text: "أعدل الخطأ الواضح وأوضح الحاجة للمراجعة.", score: 3 },
      { id: "C", text: "أؤجل الإرسال لمراجعة أوسع.", score: 2 },
      { id: "D", text: "أطلب مراجعة سريعة من زميل.", score: 1 }
    ]
  },
  {
    id: "HC-005",
    ...
    options: [
      { id: "A", text: "أستخدمها بعد مراجعة منطقها.", score: 1 },
      { id: "B", text: "أطلب نقد الفكرة وكشف ضعفها.", score: 3 },
      { id: "C", text: "أطلب صياغة أقوى للرأي.", score: 1 },
      { id: "D", text: "أقارنها بإجابة مضادة.", score: 2 }
    ]
  },
  {
    id: "HC-006",
    ...
    options: [
      { id: "A", text: "أنفذ حسب فهمي الأولي.", score: 1 },
      { id: "B", text: "أسأل عن الهدف والمخرج المطلوب.", score: 3 },
      { id: "C", text: "أقترح تصورًا أوليًا.", score: 2 },
      { id: "D", text: "أبدأ بجزء صغير ثم أعدل.", score: 2 }
    ]
  }
...
,
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أقترح فكرة مختلفة عن المعتاد.", score: 1 },
      { id: "B", text: "أجمع بدائل متعددة قبل التقييم.", score: 2 },
      { id: "C", text: "أبحث عن حل منخفض التكلفة.", score: 1 },
      { id: "D", text: "أعيد تعريف المشكلة والقيود.", score: 3 }
    ]
  },
  {
    id: "TH-011",
    ...
    options: [
      { id: "A", text: "الفريق يتأثر بوجود المدير.", score: 1 },
      { id: "B", text: "التحسن مرتبط بالرقابة الشخصية.", score: 2 },
      { id: "C", text: "النظام يحتاج آلية أداء مستقرة.", score: 3 },
      { id: "D", text: "زيادة المتابعة قد تحسن الالتزام.", score: 1 }
    ]
  },
  {
    id: "TH-012",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "الأعلى أثرًا والأقرب للهدف.", score: 3 },
      { id: "D", text: "الأسرع في إظهار نتيجة.", score: 2 }
    ]
  },
  {
    id: "TH-014",
    ...
    options: [
      { id: "A", text: "الفريق لم يطبق بروح كافية.", score: 1 },
      { id: "B", text: "قد تكون فرضيات الخطة غير صحيحة.", score: 3 },
      { id: "C", text: "الخطة تحتاج وقتًا أطول للتقييم.", score: 1 },
      { id: "D", text: "أراجع طريقة التنفيذ والافتراضات.", score: 2 }
    ]
  },
  {
    id: "TH-015",
    ...
    options: [
      ...
      { id: "B", text: "الانتشار يعطي وزنًا أوليًا.", score: 2 },
      { id: "C", text: "المعلومة المنتشرة تحتاج تحققًا.", score: 2 },
      { id: "D", text: "المصدر المشهور يحتاج مراجعة.", score: 1 }
    ]
  },
  {
    id: "TH-016",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "الإدارة الأخرى قد تكون متأثرة بالتغيير.", score: 1 },
      { id: "B", text: "نراجع نقاط التسليم والمسؤوليات.", score: 3 },
      { id: "C", text: "نطلب منهم توضيح سبب التأخر.", score: 2 },
      { id: "D", text: "نرفع الموضوع للمدير مباشرة.", score: 1 }
    ]
  },
  {
    id: "AN-010",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أقارن التكلفة أولًا.", score: 1 },
      { id: "B", text: "أدرس الأثر قبل القرار.", score: 2 },
      { id: "C", text: "أقارن التكلفة والأثر والمخاطر والتنفيذ.", score: 3 },
      { id: "D", text: "أعرض البدائل على الإدارة.", score: 1 }
    ]
  },
  {
    id: "AN-016",
...

  {
    ...
    options: [
      { id: "A", text: "أبحث عن شرح مختلف وأطبق تمرينًا.", score: 3 },
      { id: "B", text: "أعيد مشاهدة الدرس مرة أخرى.", score: 1 },
      { id: "C", text: "أجرب مثالًا أبسط أولًا.", score: 2 },
      { id: "D", text: "أنتقل للدرس التالي مؤقتًا.", score: 1 }
    ]
  },
  {
    id: "SD-008",
    ...
    options: [
      { id: "A", text: "قد يكون هناك نمط يحتاج مراجعة.", score: 3 },
      { id: "B", text: "ربما لم تصلهم فكرتي جيدًا.", score: 1 },
      { id: "C", text: "أطلب مثالًا محددًا من النقد.", score: 2 },
      { id: "D", text: "أنتظر رأيًا من شخص خبير.", score: 1 }
    ]
  },
  {
    id: "SD-009",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أستطيع تكرار التعريف بدقة.", score: 1 },
      { id: "B", text: "أستطيع تلخيصه بكلامي.", score: 2 },
      { id: "C", text: "أطبقه على مثال جديد.", score: 3 },
      { id: "D", text: "أشعر أن الفكرة واضحة.", score: 1 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "الحماس يساعدني على البداية.", score: 1 },
      { id: "B", text: "نظام بسيط يحافظ على الاستمرار.", score: 3 },
      { id: "C", text: "دورة قوية ترفع الالتزام.", score: 1 },
      { id: "D", text: "متابعة خارجية عند الحاجة.", score: 2 }
    ]
  },
  {
    id: "HC-011",
    ...
    options: [
      { id: "A", text: "هذا يعكس تحيزًا محتملًا.", score: 2 },
      { id: "B", text: "هذا تحيز تأكيدي يضعف التحليل.", score: 3 },
      { id: "C", text: "يلزم فحص أدلة مخالفة.", score: 2 },
      { id: "D", text: "عرضها على الفريق يساعد جزئيًا.", score: 1 }
    ]
  }
...
,
  {
    ...
    options: [
      { id: "A", text: "أبدأ بمدة طويلة نسبيًا.", score: 1 },
      { id: "B", text: "أحدد وقتًا قصيرًا وسلوكًا واضحًا.", score: 3 },
      { id: "C", text: "أبدأ عندما تتحسن الرغبة.", score: 1 },
      { id: "D", text: "أربط العادة بمحفز يومي.", score: 2 }
    ]
  },
  {
    id: "SD-013",
    ...
    options: [
      { id: "A", text: "أفتح أكثر من مصدر للمقارنة.", score: 1 },
      { id: "B", text: "أحفظ المصادر في قائمة لاحقة.", score: 2 },
      { id: "C", text: "أختار مصدرًا رئيسيًا وأؤجل الباقي.", score: 3 },
      { id: "D", text: "أراجع السبب قبل تغيير المسار.", score: 2 }
    ]
  },
  {
    id: "SD-014",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أؤجل المهمة إلى وقت أفضل.", score: 1 },
      { id: "B", text: "أختار مهمة صغيرة منخفضة الجهد.", score: 3 },
      { id: "C", text: "أحافظ على خطوة بسيطة.", score: 2 },
      { id: "D", text: "أكتفي بمراجعة خفيفة.", score: 1 }
    ]
  },
  {
    id: "SD-017",
    ...
    options: [
      { id: "A", text: "أحتاج نظام مساءلة تدريجي.", score: 3 },
      { id: "B", text: "المتابعة الخارجية تساعدني مؤقتًا.", score: 2 },
      { id: "C", text: "أحتاج شخصًا يراقبني باستمرار.", score: 1 },
      { id: "D", text: "أراجع سبب ضعف الالتزام.", score: 2 }
    ]
  },
  {
    id: "SD-018",
    ...
    options: [
      { id: "A", text: "أحفظ المادة للرجوع لها.", score: 1 },
      { id: "B", text: "أكتب ملخصًا يثبت الفهم.", score: 1 },
      { id: "C", text: "أطبق فكرة واحدة خلال أسبوع.", score: 3 },
      { id: "D", text: "أختار موقفًا مناسبًا للتجربة.", score: 2 }
    ]
  },
  {
    id: "SD-019",
    ...
    options: [
      { id: "A", text: "أتعلم بعد انتهاء المهام الأخرى.", score: 1 },
      { id: "B", text: "أحدد وقتًا قصيرًا ثابتًا للتعلم.", score: 3 },
      { id: "C", text: "أزيد مدة التعلم نهاية الأسبوع.", score: 1 },
      { id: "D", text: "أختار مهمة تعلم صغيرة يوميًا.", score: 2 }
    ]
  },
  {
    id: "SD-020",
    ...
    options: [
      { id: "A", text: "عدد الساعات مع ملاحظة التغير.", score: 1 },
      { id: "B", text: "شعوري بالتحسن أثناء التعلم.", score: 1 },
      { id: "C", text: "إنجاز محتوى وتطبيق جزء منه.", score: 2 },
      { id: "D", text: "تطبيق المهارة في موقف جديد.", score: 3 }
    ]
  },
  {
    id: "SD-021",
...

  {
    ...
    options: [
      { id: "A", text: "أراجع آخر مجلد استخدمته.", score: 1 },
      { id: "B", text: "أبحث بالاسم أو النوع.", score: 3 },
      { id: "C", text: "أفتش يدويًا في المجلدات.", score: 1 },
      { id: "D", text: "أستخدم كلمات قريبة للبحث.", score: 2 }
    ]
  },
  {
    id: "DA-008",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "هل النسبة مرتفعة أم منخفضة؟", score: 1 },
      { id: "B", text: "ما العدد الذي بُنيت عليه؟", score: 3 },
      { id: "C", text: "ما الفترة أو الفئة المرتبطة بها؟", score: 2 },
      { id: "D", text: "هل تدعم الاستنتاج المطلوب؟", score: 1 }
    ]
  },
  {
    id: "DA-010",
...

  {
    ...
    options: [
      { id: "A", text: "استخدام كلمة احترافي.", score: 1 },
      { id: "B", text: "تحديد السياق والهدف والجمهور والمخرج.", score: 3 },
      { id: "C", text: "زيادة عدد الكلمات المطلوبة.", score: 1 },
      { id: "D", text: "إضافة مثال قريب للمطلوب.", score: 2 }
    ]
  },
  {
    id: "AI-008",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "يوفر وقتًا إذا راجع المخرج.", score: 2 },
      { id: "B", text: "يفيد في الصياغة أكثر من الفهم.", score: 2 },
      { id: "C", text: "يضعف التعلم عند غياب الفهم.", score: 3 },
      { id: "D", text: "يناسب مهام الصياغة البسيطة.", score: 1 }
    ]
  },
  {
    id: "HC-021",
...
,
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "قد يبدو مترددًا في البداية.", score: 1 },
      { id: "B", text: "مرن إذا غيّر رأيه بدليل.", score: 3 },
      { id: "C", text: "يتأثر بالآخرين أحيانًا.", score: 1 },
      { id: "D", text: "يحتاج توضيح سبب التغيير.", score: 2 }
    ]
  },
  {
    id: "TH-020",
    ...
    options: [
      { id: "A", text: "أفحص تصميم الخطوة ومدخلاتها.", score: 3 },
      { id: "B", text: "أراجع التزام الأشخاص في الخطوة.", score: 1 },
      { id: "C", text: "أتحقق من الضوابط المستخدمة.", score: 2 },
      { id: "D", text: "أرسل تنبيهًا عامًا للفريق.", score: 1 }
    ]
  },
  {
    id: "TH-021",
...

  {
    ...
    options: [
      { id: "A", text: "أحدد نطاق المشكلة وحدودها.", score: 3 },
      { id: "B", text: "أجمع الحلول المحتملة أولًا.", score: 1 },
      { id: "C", text: "أحدد ما يدخل في التحليل.", score: 2 },
      { id: "D", text: "أكتب تقريرًا أوليًا طويلًا.", score: 1 }
    ]
  },
  {
    id: "AN-018",
    ...
    options: [
      { id: "A", text: "أحدد أكثر خطوة يظهر فيها الضغط.", score: 2 },
      { id: "B", text: "أفحص نوع الضغط ووقت ظهوره.", score: 3 },
      { id: "C", text: "أبحث هل العدد كافٍ للعمل.", score: 1 },
      { id: "D", text: "أراجع توزيع المهام بين الفريق.", score: 2 }
    ]
  },
  {
    id: "AN-019",
    ...
    options: [
      { id: "A", text: "اعتبار الفرع الأفضل نموذجًا أوليًا.", score: 1 },
      { id: "B", text: "مقارنة السياق والموارد وطريقة التشغيل.", score: 3 },
      { id: "C", text: "مراجعة أسباب انخفاض أداء الفرع.", score: 2 },
      { id: "D", text: "نقل بعض الممارسات بعد الفحص.", score: 1 }
    ]
  },
  {
    id: "AN-020",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "قد توجد نقطة اختناق رئيسية.", score: 3 },
      { id: "B", text: "قد نحتاج إعادة توزيع العمل.", score: 2 },
      { id: "C", text: "التحسينات لم تستهدف السبب.", score: 2 },
      { id: "D", text: "الفريق يحتاج متابعة أقرب.", score: 1 }
    ]
  },
  {
    id: "AN-023",
    ...
    options: [
      { id: "A", text: "إذا كان الحل مشهورًا ومجربًا.", score: 1 },
      { id: "B", text: "إذا كان سهل التنفيذ مبدئيًا.", score: 1 },
      { id: "C", text: "إذا عالج سببًا محددًا ومقاسًا.", score: 3 },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أفصل الشعور عن تقييم الخطأ.", score: 3 },
      { id: "B", text: "أترك المهمة حتى يخف الإحباط.", score: 1 },
      { id: "C", text: "أحدد تعديلًا واحدًا للتجربة.", score: 2 },
      { id: "D", text: "أضغط على نفسي أكثر.", score: 1 }
    ]
  },
  {
    id: "SD-024",
...

  {
    ...
    options: [
      { id: "A", text: "تحسين شكل الجدول.", score: 1 },
      { id: "B", text: "تنظيم البيانات لاكتشاف نمط.", score: 3 },
      { id: "C", text: "تسهيل مراجعة حالات محددة.", score: 2 },
      { id: "D", text: "تحويل البيانات إلى عرض.", score: 1 }
    ]
  },
  {
    id: "DA-013",
    ...
    options: [
      { id: "A", text: "كتابة النص مع عناوين محدودة.", score: 1 },
      { id: "B", text: "استخدام عناوين وأنماط ونسخة واضحة.", score: 3 },
      { id: "C", text: "إرسال التقرير بصيغة قابلة للقراءة.", score: 2 },
      { id: "D", text: "تنسيق يدوي مع مراجعة أخيرة.", score: 1 }
    ]
  },
  {
    id: "DA-014",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "يساعد في تنظيم الملفات.", score: 1 },
      { id: "B", text: "يدعم الوصول والنسخ الاحتياطي والمشاركة.", score: 3 },
      { id: "C", text: "يحسن المشاركة عند ضبط الصلاحيات.", score: 2 },
      { id: "D", text: "يسهل الرجوع للنسخ السابقة.", score: 2 }
    ]
  },
  {
    id: "DA-016",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "حسّن الصياغة والأسلوب.", score: 1 },
      { id: "B", text: "وسّع الخطة بتفاصيل أكثر.", score: 1 },
      { id: "C", text: "انتقد الخطة واكشف الافتراضات والمخاطر.", score: 3 },
      { id: "D", text: "اقترح نقاط ضعف محتملة.", score: 2 }
    ]
  },
  {
    id: "AI-015",
    ...
    options: [
      { id: "A", text: "أطلب تقسيمها لمراحل ومخرجات.", score: 3 },
      { id: "B", text: "أطلب تنفيذها دفعة واحدة.", score: 1 },
      { id: "C", text: "أطلب تحديد معايير القبول.", score: 2 },
      { id: "D", text: "أطلب رأيًا عامًا في المهمة.", score: 1 }
    ]
  },
  {
    id: "AI-016",
    ...
    options: [
      { id: "A", text: "أستخدمها إذا بدت منطقية.", score: 1 },
      { id: "B", text: "أطلب مصادر وأتحقق منها.", score: 3 },
      { id: "C", text: "أطلب منه إعادة التأكيد.", score: 1 },
      { id: "D", text: "أقارنها بمصدر موثوق.", score: 2 }
    ]
  },
  {
    id: "AI-017",
...

  {
    ...
    options: [
      ...
      { id: "B", text: "أتوقف فترة قصيرة للتفكير.", score: 1 },
      { id: "C", text: "أبحث عن سبب الخطأ.", score: 2 },
      { id: "D", text: "أكمل بعد تهدئة الانفعال.", score: 1 }
    ]
  },
  {
    id: "HC-023",
...
,
  {
    ...
    options: [
      { id: "A", text: "أقبل الكلام إذا كان منظمًا.", score: 1 },
      { id: "B", text: "أقارن جودة العرض بقوة الدليل.", score: 3 },
      { id: "C", text: "أطلب دليلًا يدعم الفكرة.", score: 2 },
      { id: "D", text: "أعتمد على انطباعي الأول.", score: 1 }
    ]
  },
  {
    id: "TH-025",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أوافق حتى لا أؤثر على النقاش.", score: 1 },
      { id: "B", text: "أطرح سؤالًا عن الدليل.", score: 3 },
      { id: "C", text: "أعرض تحفظي دون تصعيد.", score: 2 },
      { id: "D", text: "أرفض الرأي مباشرة أمام الجميع.", score: 1 }
    ]
  },
  {
    id: "TH-030",
    ...
    options: [
      { id: "A", text: "أجمع معلومات إضافية عند الحاجة.", score: 1 },
      { id: "B", text: "أرتبها في أنماط وعلاقات واستنتاجات.", score: 3 },
      { id: "C", text: "أحدد العلاقات بين النقاط.", score: 2 },
      { id: "D", text: "ألخصها في نقاط رئيسية.", score: 1 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "C", text: "المؤقت يعالج العرض الأساسي.", score: 1 },
      { id: "D", text: "الجذري يتطلب فهم السبب.", score: 2 }
    ]
  },
  {
    id: "AN-027",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "قد توجد عوامل أخرى مؤثرة.", score: 3 },
      { id: "B", text: "المبادرة ربما ساهمت في التحسن.", score: 1 },
      { id: "C", text: "نحتاج فحص العوامل المصاحبة.", score: 2 },
      { id: "D", text: "نقارن النتائج بفترة سابقة.", score: 2 }
    ]
  },
  {
    id: "AN-030",
    ...
    options: [
      { id: "A", text: "حل واضح مع تبرير مختصر.", score: 1 },
      { id: "B", text: "توصية مرتبطة بسبب وأثر.", score: 3 },
      { id: "C", text: "اقتراح عملي قابل للتنفيذ.", score: 2 },
      { id: "D", text: "رأي خبير بلغة قوية.", score: 1 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "اعتباره مؤشرًا يحتاج تحليلًا.", score: 2 },
      { id: "C", text: "تخفيف أثره على الحماس.", score: 1 },
      { id: "D", text: "استخدامه لتعديل طريقة التدريب.", score: 2 }
    ]
  },
  {
    id: "SD-028",
    ...
    options: [
      { id: "A", text: "دفعات حماس كبيرة متقطعة.", score: 1 },
      { id: "B", text: "تطبيق قصير منتظم ومراجعة أسبوعية.", score: 3 },
      { id: "C", text: "قراءة طويلة دون تطبيق كافٍ.", score: 1 },
      { id: "D", text: "تجربة عملية قصيرة متكررة.", score: 2 }
    ]
  },
  {
    id: "SD-029",
    ...
    options: [
      { id: "A", text: "عندما أحدد ما جربته وما تعطل.", score: 3 },
      { id: "B", text: "عندما أطلب توجيهًا لا تنفيذًا.", score: 2 },
      { id: "C", text: "عندما أوضح السؤال المطلوب.", score: 2 },
      { id: "D", text: "عندما أحتاج تسريع الفهم.", score: 1 }
    ]
  },
  {
    id: "SD-030",
    ...
    options: [
      { id: "A", text: "إنهاء الدورة يساوي الإتقان.", score: 1 },
      { id: "B", text: "الإتقان يظهر في تطبيق متكرر.", score: 3 },
      { id: "C", text: "حفظ الدروس يساعد على البداية.", score: 1 },
      { id: "D", text: "التطبيق يكشف جودة الفهم.", score: 2 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أن أعرف أسماء الأدوات.", score: 1 },
      { id: "B", text: "أن أنتج مخرجًا يحل مشكلة.", score: 3 },
      { id: "C", text: "أن أطبق الأداة في عمل فعلي.", score: 2 },
      { id: "D", text: "أن أشاهد شروحات كثيرة.", score: 1 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "أراجع سبب التشتت.", score: 2 },
      { id: "C", text: "أؤجل التعلم مؤقتًا.", score: 1 },
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "أحدد الخطوة التي تعثرت.", score: 3 },
      { id: "B", text: "أراجع طريقة التطبيق.", score: 2 },
      { id: "C", text: "أحتاج مصدرًا أوضح.", score: 1 },
      { id: "D", text: "أحتاج حماسًا أعلى.", score: 1 }
    ]
  },
  {
    id: "HC-028",
    ...
    options: [
      { id: "A", text: "دفعات قوية ثم انقطاع.", score: 1 },
      { id: "B", text: "قليل منتظم ومراجعة دورية.", score: 3 },
      { id: "C", text: "أنتظر ظروفًا أفضل.", score: 1 },
      { id: "D", text: "أبدأ بقوة ثم أغيّر المسار.", score: 1 }
    ]
  },
  {
    id: "HC-029",
    ...
    options: [
      { id: "A", text: "طلبه يحتاج تحديدًا أكثر.", score: 3 },
      { id: "B", text: "طلب المساعدة أفضل من التوقف.", score: 2 },
      { id: "C", text: "يعتمد على غيره بدرجة زائدة.", score: 2 },
      { id: "D", text: "ينقصه وصف ما جربه.", score: 2 }
    ]
  },
  {
    id: "HC-030",
